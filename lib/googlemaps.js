...
exports.places = function(latlng, radius, key, callback, sensor, types, lang, name, rankby, secure) {
  ...
  var DEFAULT_RANKBY = 'prominence';
  var DISTANCE_RANKBY = 'distance';

  rankby = rankby || DEFAULT_RANKBY
  if (rankby !== DEFAULT_RANKBY && rankby !== DISTANCE_RANKBY) {
    rankby = DEFAULT_RANKBY;
  }
  args.rankby = rankby;
  ...
  if (typeof radius !== "undefined" && radius !== null && rankby !== DISTANCE_RANKBY) {
    args.radius = radius;
  }
